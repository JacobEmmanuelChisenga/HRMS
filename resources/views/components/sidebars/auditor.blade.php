<!-- Auditor Sidebar - Read-Only Access -->
<div x-data="{ 
    openSections: {
        dashboard: true,
        employees: false,
    ...
    <div class="space-y-2">
        ...
        <div x-show="openSections.dashboard" x-transition class="ml-8 space-y-1">
            <a href="{{ route('dashboard', ['section' => 'overview']) }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 {{ request()->routeIs('dashboard') && (request()->get('section') == 'overview' || !request()->has('section')) ? 'bg-blue-50 text-blue-600' : 'text-gray-600' }}">
                ...
                <span class="text-sm">Compliance Overview</span>
            </a>
            <a href="{{ route('dashboard', ['section' => 'stats']) }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 {{ request()->routeIs('dashboard') && request()->get('section') == 'stats' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' }}">
                <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                <span class="text-sm">Audit Statistics</span>
            </a>
        </div>
    </div>
    ...
    <div class="space-y-2 mt-2">
        <button @click="toggle('leaveManagement')" class="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-gray-100 {{ request()->routeIs('leaves.*') || request()->routeIs('leave-types.*') || request()->routeIs('leave-balances.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700' }}">
            <div class="flex items-center space-x-3">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="openSections.leaveManagement" x-transition class="ml-8 space-y-1">
            ...
            <a href="{{ route('leave-types.index') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 {{ request()->routeIs('leave-types.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600' }}">
                <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                <span class="text-sm">Leave Types</span>
            </a>
            <a href="{{ route('leave-balances.index') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 {{ request()->routeIs('leave-balances.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600' }}">
                <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
                <span class="text-sm">Leave Balances</span>
            </a>
        </div>
    </div>
    ...
    <!-- Reports -->
    <div class="space-y-2 mt-2">
        <button @click="toggle('reports')" class="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-gray-100 {{ request()->routeIs('reports.*') || request()->routeIs('attendance.reports.*') || request()->routeIs('reports.leaves.*') || request()->routeIs('reports.documents.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-700' }}">
            <div class="flex items-center space-x-3">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
    ...
    <div class="space-y-2 mt-2">
        ...
        <div x-show="openSections.audit" x-transition class="ml-8 space-y-1">
            ...
            <a href="{{ route('audit.documents.access-logs') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 {{ request()->routeIs('audit.documents.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600' }}">
                <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
            ...
            <a href="{{ route('audit.compliance.reports') }}" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 {{ request()->routeIs('audit.compliance.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600' }}">
                <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
