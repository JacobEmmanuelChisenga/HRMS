...
@section('page-title', 'Rejected Leaves')

@section('content')
<div class="space-y-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-900">Rejected Leaves</h2>
        <p class="text-gray-600 mt-1">View all rejected leave requests</p>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $leave->approver_comments ?? 'N/A' }}</td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-gray-500">No rejected leaves found</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
