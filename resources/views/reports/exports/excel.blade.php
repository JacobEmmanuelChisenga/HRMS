...
@section('page-title', 'Export to Excel')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Export to Excel</h2>
            <p class="text-gray-600 mt-1">Export data to Excel format</p>
        </div>
