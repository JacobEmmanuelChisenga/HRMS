...
@section('page-title', 'Attendance Trends')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Monthly attendance trends over time</p>
        </div>
        <div class="flex space-x-3">
            <form method="GET" action="{{ route('reports.attendance.trends') }}" class="flex items-center space-x-3">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ number_format($trend['total_hours'], 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
