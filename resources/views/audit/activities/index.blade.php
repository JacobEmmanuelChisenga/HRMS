...
@section('page-title', 'All Activities')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">All Activities</h2>
            <p class="text-gray-600 mt-1">Complete activity log for your company</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="GET" action="{{ route('audit.activities.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div class="md:col-span-4 flex items-end space-x-3">
                <a href="{{ route('audit.activities.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                    Clear
                </a>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">{{ Str::limit($activity->description, 100) }}</td>
