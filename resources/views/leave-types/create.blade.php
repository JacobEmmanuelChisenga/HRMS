        ...
        <form action="{{ route('leave-types.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="days_allowed" value="{{ old('days_allowed') }}" min="0" max="365" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_carry_forward_days" value="{{ old('max_carry_forward_days') }}" min="0" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="is_paid" value="1" {{ old('is_paid', true) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Is Paid Leave</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="carries_forward" value="1" {{ old('carries_forward') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Carries Forward to Next Year</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="requires_document" value="1" {{ old('requires_document') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t">
                <a href="{{ route('leave-types.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">Cancel</a>
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Leave Type</button>
            </div>
        </form>
    </div>
</div>
